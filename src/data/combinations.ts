...
export const combinations: CombinationPage[] = [
  ...
  },
  {
    ...
    baseNote: 'The glycerin base creates a light, smooth lather and an easy-rinsing finish.',
  ...
  },
  {
    ...
    ingredientNote: 'Locally sourced honey and finely processed oats combine to create a mild, smooth wash with a light, gentle texture.',
    baseNote: 'The glycerin base creates a light, clean lather that rinses away easily.',
  ...
  },
  {
    ...
    baseNote: 'The glycerin base creates a light, clean lather that rinses away without heaviness.',
