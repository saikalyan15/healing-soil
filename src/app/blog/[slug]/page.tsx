...
const relatedProductsBySlug: Record<string, string[]> = {
  ...
  'shea-butter-goat-milk-soap-dry-sensitive-skin': ['shea-butter-kesar-gulab', 'neem-tulsi-goat-milk-soap'],
  'understanding-the-benefits-of-shea-butter-in-soap': ['shea-butter-kesar-gulab'],
