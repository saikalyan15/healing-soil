...
const soapSquares: SoapSquareCatalogItem[] = [
  {
    ...
    base: 'Glycerin',
    image: `${IMAGE_BASE}/neem-tulsi-glycerine-50g.webp`,
  },
  {
    id: 'honey-oats-glycerin',
    name: 'Honey Oats Glycerin',
    base: 'Glycerin',
    image: `${IMAGE_BASE}/honey-oats-glycerin-50g.webp`,
  },
  {
    id: 'ginger-rosemary-glycerin',
    name: 'Ginger Rosemary Glycerin',
    base: 'Glycerin',
    image: `${IMAGE_BASE}/ginger-rosemary-glycerin-50g.webp`,
  },
  {
    id: 'orange-glycerine',
    name: 'Orange Glycerin',
    base: 'Glycerin',
    image: `${IMAGE_BASE}/orange-glycerine-50g.webp`,
  },
  {
    id: 'pomegranate-glycerin',
    name: 'Pomegranate Glycerin',
    base: 'Glycerin',
    image: `${IMAGE_BASE}/pomegranate-glycerin-50g.webp`,
  },
  {
    id: 'marigold-glycerine',
    name: 'Marigold Glycerin',
    base: 'Glycerin',
    image: `${IMAGE_BASE}/marigold-glycerine-50g.webp`,
  },
  {
    id: 'neem-tulsi-goatmilk',
    name: 'Neem Tulsi Goat Milk',
    base: 'Goat Milk',
    image: `${IMAGE_BASE}/neem-tulsi-goatmilk-50g.webp`,
  },
  {
    id: 'honey-oats-goatmilk',
    name: 'Honey Oats Goat Milk',
    base: 'Goat Milk',
    image: `${IMAGE_BASE}/honey-oats-goatmilk-50g.webp`,
  },
  {
    id: 'ginger-rosemary-goat-milk',
    name: 'Ginger Rosemary Goat Milk',
    base: 'Goat Milk',
    image: `${IMAGE_BASE}/ginger-rosemary-goat-milk-50g.webp`,
  },
  {
    id: 'orange-goatmilk',
    name: 'Orange Goat Milk',
    base: 'Goat Milk',
    image: `${IMAGE_BASE}/orange-goatmilk-50g.webp`,
  },
  {
    id: 'pomegranate-goatmilk',
    name: 'Pomegranate Goat Milk',
    base: 'Goat Milk',
    image: `${IMAGE_BASE}/pomegranate-goatmilk-50g.webp`,
  },
  {
    id: 'kesar-haldi-goatmilk',
    name: 'Kesar Haldi Goat Milk',
    base: 'Goat Milk',
    image: `${IMAGE_BASE}/kesar-haldi-goatmilk-50g.webp`,
  },
  {
    id: 'kesar-gulab-sheabutter',
    name: 'Kesar Gulab Shea Butter',
    base: 'Shea Butter',
    image: `${IMAGE_BASE}/kesar-gulab-sheabutter-50g.webp`,
  },
  {
    id: 'honey-kesar-haldi-sheabutter',
    name: 'Honey Kesar Haldi Shea Butter',
    base: 'Shea Butter',
    image: `${IMAGE_BASE}/honey-kesar-haldi-sheabutter-50g.webp`,
  },
  {
    id: 'red-rose',
    name: 'Red Rose',
    base: 'Seasonal',
    image: `${IMAGE_BASE}/red-rose-50g.webp`,
  },
]
