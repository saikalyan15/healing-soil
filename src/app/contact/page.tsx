    ...
    <div className="min-h-screen bg-[#F7F5F0]">
      <div className="mx-auto max-w-xl px-4 py-16 sm:px-6">
        ...
        <a
          ...
          className="mb-8 flex w-full items-center justify-center gap-3 rounded-lg bg-[#1E5631] px-8 py-4 font-sans text-base font-medium text-white transition-colors hover:bg-[#25D366]"
        >
