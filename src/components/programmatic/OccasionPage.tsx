...
import type { OccasionPage as OccasionPageType } from '@/data/occasions'

type Props = {
  occasion: OccasionPageType
  products: Product[]
}

const OccasionPage: React.FC<Props> = ({ occasion, products }) => {
  const faqSchema = {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: occasion.h1,
        item: `https://healingsoil.in/occasion/${occasion.slug}`,
      },
    ],
  }
    ...
    <div className="bg-[#F7F5F0]">
      ...
      <article className="mx-auto max-w-[720px] px-4 py-16 sm:px-6">
        ...
        <div className="mb-12 border-t border-[#D6CFC4] pt-8">
          <h3 className="mb-6 font-serif text-2xl text-[#1E5631]">Recommended collection</h3>
