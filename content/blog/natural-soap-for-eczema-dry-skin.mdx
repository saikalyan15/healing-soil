...
Neem has a long history of use for itchy, inflamed skin. It contains compounds — azadirachtin, nimbidin — that have anti-inflammatory and antimicrobial properties. For eczema skin that is also prone to bacterial infection at scratch sites, this can make a real difference.
...
Natural soap is not a cure for eczema. Nothing applied topically is. But removing daily irritants — switching from a harsh commercial soap to something gentler — can meaningfully reduce the frequency and severity of flares.
