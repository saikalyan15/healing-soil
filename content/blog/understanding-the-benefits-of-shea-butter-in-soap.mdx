...
In cold-process soap making, the saponification reaction converts most of the oils into soap molecules. But soap makers deliberately calculate the formula to leave a percentage of oil unreacted. This is called superfatting. With shea butter as part of the formula, the superfat includes shea butter's non-saponifiable compounds — vitamins, cinnamic esters, fatty acids — deposited directly on the skin during washing and left there after rinsing.
